# COPY of dev/release/run-check.ps1 for lane wt-simnewdata: the three
# packages this lane changed, against the lane library first.
...
$LOG  = "$ROOT/dev/simnewdata-log/check.log"
$OUT  = "C:/Users/adf44/source/r/simnewdata-check"
...
[void]$pkgs.Add($ROOT)
foreach ($n in @("frmtmb.sample", "frmtmb.learn")) {
