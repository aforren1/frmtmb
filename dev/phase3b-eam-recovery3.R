...
# The rerun harness: the second one, taking a LIST of seeds and writing
...
dir.create("dev/phase3b-log/recov-rerun", showWarnings = FALSE, recursive = TRUE)
...
for (seed in seeds) {
  ...
  saveRDS(res, sprintf("dev/phase3b-log/recov-rerun/%s-%d.rds", arm, seed))
