# COPY of dev/simnewdata-run-check.ps1 for punch round 1: frmtmb and
# frmtmb.sample, the two packages round 1 changed.
...
$LOG  = "$ROOT/dev/simnewdata-log/check-r2.log"
$OUT  = "C:/Users/adf44/source/r/simnewdata-check-r2"
