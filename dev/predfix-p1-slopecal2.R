# Punch round 1, M1 calibration part 2: refine the random-slope onset
# between 1e-2 (6 of 32 short) and 3e-2 (0 of 32), 16 seeds.
...
for (fam in c("gau", "pois")) for (tau in c(0.1, 0.4)) for (seed in 1:16) {
  ...
  for (s in c(6e-2, 4e-2, 3e-2, 2e-2)) {
    d$x <- d$x0 * s
...
saveRDS(r, "C:/Users/adf44/source/r/frmtmb-wt-predfix/dev/predfix-log/p1-slopecal2.rds")
options(width = 200)
