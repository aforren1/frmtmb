# COPY of dev/simnewdata-run-check-r2.ps1 for the closing Rd change:
# frmtmb alone.
...
$LOG  = "$ROOT/dev/simnewdata-log/check-r3.log"
$OUT  = "C:/Users/adf44/source/r/simnewdata-check-r3"
