# frmtmb.sample alone: its check was cut off by the 18:39 shutdown.
...
$LOG  = "$ROOT/dev/predfix-log/check-sample.log"
$OUT  = "C:/Users/adf44/source/r/predfix-check-sample"
