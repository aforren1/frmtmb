## Lane brmsnames' copy of dev/brmsmatch-beyond.R, unchanged except
## that it takes the arm, so the BEFORE and AFTER counts come from one
## script:  Rscript dev/brmsnames-beyond.R base|lane
##
