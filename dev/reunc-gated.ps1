# Lane wt-reunc: a copy of dev/release/run-gated.ps1 whose only
# changes are the tree, the runner (dev/reunc-run-tests.R, the lane
# library first) and the log path. Every environment variable the
# release script sets is set here too.
#
...
$LOG  = "$ROOT/dev/reunc-log/gated.log"
