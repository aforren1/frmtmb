# Lane wt-correct copy of dev/release/run-suite.ps1, with the lane library in
# front of the round reference build and the lane tree as ROOT.
# The release script itself is not edited.
...
$LOG  = "$ROOT/dev/correct-log/suite.log"
