...
# frm_ode_records() before the round-3 fixes, recovered from the check
# tarball built for the punch-round-1 R CMD check
# (C:/Users/adf44/source/r/phase3a-round2/frmtmb.ode/R/records.R), put
...
sys.source("C:/Users/adf44/source/r/phase3a-round2/frmtmb.ode/R/records.R",
           envir = old)
