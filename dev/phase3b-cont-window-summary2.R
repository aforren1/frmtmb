# Summarise dev/phase3b-cont-window.R. Output: dev/phase3b-log/contwin2.txt
f <- list.files("dev/phase3b-log/contwin2", full.names = TRUE)
...
writeLines(out, "dev/phase3b-log/contwin2.txt")
cat(out, sep = "\n")
