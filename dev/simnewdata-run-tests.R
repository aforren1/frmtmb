# COPY of dev/release/run-tests.R for lane wt-simnewdata: the lane
# library first, the round's read-only base second. Nothing else changed.
...
LIB <- "C:/Users/adf44/source/r/simnewdata-lib"
