...
#' matrix, and [loo()], [waic()] and `loo::psis()` take it directly.
#'
...
loo_compare.default <- function(x, ...) {
  ...
  # namespace would find this function again and recurse forever.
  if (!requireNamespace("loo", quietly = TRUE)) {
