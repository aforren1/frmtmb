...
#'   The 530 `stop()` calls that carry literal text produce 530 distinct
#'   messages (mechanically re-verified after the numerical-robustness
#'   batch by an AST walk), so a
