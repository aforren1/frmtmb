...
#'   The 438 `stop()` calls that carry literal text produce 438 distinct
#'   messages (mechanically re-verified by an AST walk after the hmm()
#'   family was added, which contributed 33 of them), so a
