...
#'   The 426 `stop()` calls that carry literal text produce 426 distinct
#'   messages (mechanically re-verified after the multi-membership lane
#'   by an AST walk; 405 before it added `mm()`/`mmc()`), so a
