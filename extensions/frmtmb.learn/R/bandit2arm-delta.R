...
#' every row is. `newdata` is not a way round it, because the formula
#' names one column twice and `newdata` is read through that same
#' formula; refit with a column per arm.
#'
