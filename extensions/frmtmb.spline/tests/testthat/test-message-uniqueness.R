...
test_that("every condition message template in this R/ is unique", {
  ...
  # refusals are the whole surface here, because every one of them names
  # a thing the construction cannot do rather than a thing that went
  # wrong. The sum still guards against a collect() that silently
