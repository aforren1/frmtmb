...
#
# Design: two-compartment oral, ke 0.1, k12 0.2, k21 0.008, ka 1.0,
# V 10, ii 24, terminal half-life 264.6 h, 30 subjects x 7 samples,
# which is the design `dev/rev-lincmt-nss.R` section C actually ran and
# where it measured the k21 factor of 3.16 on seed 101,
# random effects on lke and lka, data simulated from the EXACT steady
# state. Seeds 101 to 106.
#
# Script path: extensions/frmtmb.ode/dev/nss/nss-18-accept-265.R
