...
#> 41   trunc()  aterm                       hmm structure refused
#> 42   trunc()  aterm                       lca structure refused
#>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               note
...
#> 41                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Refused for the same reason as cens().
#> 42                                                                                                                                                                                                                                                                                                                             Refused: an lca() response is a matrix of item codes with no per-row weight, censoring window, trial count or known standard error to attach an addition term to. One message covers the whole set.
