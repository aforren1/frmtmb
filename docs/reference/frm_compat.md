...
#> 21   trunc()  aterm    zero_one_inflated_beta    family refused
#> 22   trunc()  aterm            hurdle_poisson    family refused
#> 23   trunc()  aterm        hurdle_negbinomial    family refused
#> 24   trunc()  aterm              hurdle_gamma    family refused
#> 25   trunc()  aterm          hurdle_lognormal    family refused
#> 26   trunc()  aterm                cumulative    family refused
#> 27   trunc()  aterm                    sratio    family refused
#> 28   trunc()  aterm                    cratio    family refused
#> 29   trunc()  aterm                      acat    family refused
#> 30   trunc()  aterm               categorical    family refused
#> 31   trunc()  aterm                 von_mises    family refused
#> 32   trunc()  aterm                      mi()     aterm refused
#> 33   trunc()  aterm                   thres()     aterm refused
...
#> 24                                                                                                                                                                                                                                                                                                                                                                                                                                                                             Refused: trunc() needs a family with an AD log-CDF.
#> 25                                                                                                                                                                                                                                                                                                                                                                                                                                                                             Refused: trunc() needs a family with an AD log-CDF.
...
#> 28                                                                                                                                                                                                                                                                                                                                                                                                                                                          Refused: ordinal families carry no AD log-CDF over the response scale.
#> 29                                                                                                                                                                                                                                                                                                                                                                                                                                                          Refused: ordinal families carry no AD log-CDF over the response scale.
#> 30                                                                                                                                                                                                                                                                                                                                                                                                                                                            Refused for the same reason: no order, no CDF, no truncation window.
#> 31                                                                                                                                                                                                                                                                                                                                                                                                                                                                             Refused: trunc() needs a family with an AD log-CDF.
#> 32                                                                                                                                                                                                                                                                                                                                                                                                                                            Refused: mi() cannot be combined with cens(), trunc(), or se() on the same response.
#> 33                                                                                                                                                                                                                                                                                                                                                                                                                                                    Refused: the ordinal families that thres() belongs to do not take this term.
