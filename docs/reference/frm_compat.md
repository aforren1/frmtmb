...
#> 41   trunc()  aterm                    wiener    family refused
#> 42   trunc()  aterm                      gddm    family refused
#> 43   trunc()  aterm                       lba    family refused
#> 44   trunc()  aterm                wiener_gng    family refused
#> 45   trunc()  aterm          bandit2arm_delta    family refused
#> 46   trunc()  aterm           bandit2arm_dual    family refused
#> 47   trunc()  aterm            prl_fictitious    family refused
#> 48   trunc()  aterm bandit4arm2_kalman_filter    family refused
#> 49   trunc()  aterm                   ts_par7    family refused
#> 50   trunc()  aterm             igt_pvl_delta    family refused
#> 51   trunc()  aterm                   igt_orl    family refused
#> 52   trunc()  aterm                     rlddm    family refused
#>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               note
...
#> 41                                                                                                                                                                                                                                                                                                                                                                                                                                             Same reason as cens(): no lcdf, so frmtmb has no normalizing constant to divide by.
#> 42                                                                                                                                                                                                                                                                                                                                                                                                                                                No lcdf, so there is no normalizing constant for frmtmb to divide the window by.
#> 43                                                                                                                                                                                                                                                                                                                                                                                                                                                                      Same reason as cens(): no lcdf, so there is no normalizer.
#> 44                                                                                   By frmtmb, because the family declares no lcdf, and the family declares none on purpose. This likelihood is a defective density plus a point mass at no-response, and a truncation window on the response scale renormalizes the density while saying nothing about the mass, so the two halves of every row would be divided by different things. Right censoring has no such problem, because it replaces a row rather than reweighting it.
#> 45                                                                                                                                                                                                                                                                                                                                           Refused in check_spec. Same reason as cens(): a truncation window divides a row's density by a probability, and a trial's density here is conditional on its subject's whole history.
#> 46                                                                                                                                                                                                                                                                                                                                           Refused in check_spec. Same reason as cens(): a truncation window divides a row's density by a probability, and a trial's density here is conditional on its subject's whole history.
#> 47                                                                                                                                                                                                                                                                                                                                           Refused in check_spec. Same reason as cens(): a truncation window divides a row's density by a probability, and a trial's density here is conditional on its subject's whole history.
#> 48                                                                                                                                                                                                                                                                                                                                           Refused in check_spec. Same reason as cens(): a truncation window divides a row's density by a probability, and a trial's density here is conditional on its subject's whole history.
#> 49                                                                                                                                                                                                                                                                                                                                           Refused in check_spec. Same reason as cens(): a truncation window divides a row's density by a probability, and a trial's density here is conditional on its subject's whole history.
#> 50                                                                                                                                                                                                                                                                                                                                           Refused in check_spec. Same reason as cens(): a truncation window divides a row's density by a probability, and a trial's density here is conditional on its subject's whole history.
#> 51                                                                                                                                                                                                                                                                                                                                           Refused in check_spec. Same reason as cens(): a truncation window divides a row's density by a probability, and a trial's density here is conditional on its subject's whole history.
#> 52                                                                                                                                                                                                                                                                                                                                           Refused in check_spec. Same reason as cens(): a truncation window divides a row's density by a probability, and a trial's density here is conditional on its subject's whole history.
#> 
#> Unresolved rule sides in this session: 'hmm', 'lca'. A registered rule
#> names each, declared through frmtmb_register_compat(expects =) as a
#> feature another package supplies. No feature here answers to them, so
