...
#> 29   trunc()  aterm                      ar()   autocor refused
#> 30   trunc()  aterm                      ma()   autocor refused
#> 31   trunc()  aterm                    arma()   autocor refused
#> 32   trunc()  aterm                    cosy()   autocor refused
#> 33   trunc()  aterm                   unstr()   autocor refused
#> 34   trunc()  aterm                quadrature      mode refused
#> 35   trunc()  aterm                    rescor structure refused
#> 36   trunc()  aterm                   mixture structure refused
#> 37   trunc()  aterm               mixture_mvn structure refused
#> 38   trunc()  aterm              bar_crossing   grammar refused
#>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               note
