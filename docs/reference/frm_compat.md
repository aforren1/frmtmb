...
#> 41   trunc()  aterm                      gddm    family refused
#> 42   trunc()  aterm                       lba    family refused
#> 43   trunc()  aterm                wiener_gng    family refused
#> 44   trunc()  aterm          bandit2arm_delta    family refused
#> 45   trunc()  aterm           bandit2arm_dual    family refused
#> 46   trunc()  aterm            prl_fictitious    family refused
#> 47   trunc()  aterm bandit4arm2_kalman_filter    family refused
#> 48   trunc()  aterm                   ts_par7    family refused
#> 49   trunc()  aterm             igt_pvl_delta    family refused
#> 50   trunc()  aterm                   igt_orl    family refused
#> 51   trunc()  aterm                     rlddm    family refused
#>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               note
