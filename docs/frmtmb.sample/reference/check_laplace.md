...
The srr standard this function used to carry (RE1.4, "the assumptions
the model rests on are documented and testable") is claimed by
[`frmtmb::frm()`](https://aforren1.github.io/frmtmb/reference/frm.html)
now that the two live in different packages: the assumption is the
FIT's, and core has to state it whether or not this package is
installed. See the Laplace approximation section of
[`?frmtmb::frm`](https://aforren1.github.io/frmtmb/reference/frm.html).
