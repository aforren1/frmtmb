...
Pre-release (v0.19), working toward CRAN. The test suite holds about 850
tests; every model class is validated against an exact reference
(glmmTMB, lme4, mgcv, MASS, survival, nnet, GLMMadaptive, quantreg,
closed-form marginals, or hand-written ML) - see `tests/testthat/` and
`dev/feature-gaps.md`.
