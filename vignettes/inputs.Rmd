...
| `Date`, `POSIXct` | No special handling. `model.matrix()` reduces the column to its numeric value, which gives one coefficient per day or per second. Nothing checks this, so convert to the unit you want the coefficient in. |
