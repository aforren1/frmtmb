...
This study moved. `hmm()` now lives in the `frmtmb.latent` package,
and the animal-track fit, its cross-checks against hmmTMB and
depmixS4, and the list of what the HMM surface refuses are in
...
than that: `vignette("latent", package = "frmtmb.latent")` works
through the whole refusal set of one such family.
